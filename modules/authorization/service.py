...
DEFAULT_PERMISSIONS: list[tuple[str, str, str]] = [
    ...
    ("expense_claims.view", "expense_claims", "View employee expense reimbursement claims"),
    ("expense_claims.manage", "expense_claims", "Approve or reject employee expense reimbursement claims"),
