...
/**
 * Wraps any route that requires authentication. Redirects to /login if
 * there is no valid session, and — beyond mere authentication — checks
 * that this account's real access (RBAC role/Trainer/Employee/Student)
 * actually belongs on the Trainer Portal at all; see
 * wrong-portal-screen.tsx for what a mismatch shows and
